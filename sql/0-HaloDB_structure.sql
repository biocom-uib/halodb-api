...
-- The HaloDB 
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `halodb` DEFAULT CHARACTER SET utf8mb4 ;
USE `halodb` ;
...
CREATE TABLE IF NOT EXISTS `halodb`.`user` (
  ...
  `surname` VARCHAR(80) CHARACTER SET 'utf8mb4' NULL,
...
CREATE TABLE IF NOT EXISTS `halodb`.`oxygen` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `relationship` VARCHAR(40) CHARACTER SET 'utf8mb4' NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `halodb`.`publication_has_author` (
  ...
  `coau` TINYINT DEFAULT 0 COMMENT 'The author is a corresponding author of the publication.',
...
CREATE TABLE IF NOT EXISTS `halodb`.`sample` (
  ...
  `ssizeunit` ENUM('μl', 'ml', 'l', 'g', 'Kg') CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Units of ssize',
  ...
  `cult` ENUM('cultured', 'uncultured') CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Is the sample cultured or uncultured?',
  `koma` ENUM('isolate', 'MAG', 'SAG', 'virus', 'viral contig', 'plasmid') CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Kind of material',
  `typn` TINYINT NULL DEFAULT NULL COMMENT 'Is this the designed type material for a new taxon?',
  `otyp` VARCHAR(30) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'If it is not a new taxon (TYPN = false), indicate the strain or MAG or SAG from which the reference taxon was obtained.',
  `txnr` INT NULL DEFAULT NULL COMMENT 'NCBI Taxonomy number of the type material (in case of member of an extant taxon)',
  `ccsu` TINYINT NULL DEFAULT NULL COMMENT 'If cultured, has been submitted to culture collection?',
  `type` VARCHAR(30) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Designated type strain name/MAG/SAG (if TYPN)',
  `coln` VARCHAR(80) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Strain collection numbers',
  `coth` VARCHAR(500) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Other',
  `publication` INT NULL COMMENT 'Publication data',
  `sixteensr` VARCHAR(20) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT '16S rRNA gene accession number',
  `meca` VARCHAR(20) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'INSDC (International Nucleotide Sequence Database Collaboration) metagenome accession number.',
  `twentythreesr` VARCHAR(20) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT '23S rRNA gene accession number',
  `gare` VARCHAR(20) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'genome/MAG/SAG accession number [RefSeq/ENA]',
  `seqdepth` INT NULL DEFAULT NULL COMMENT 'Sequencing depth (Isolates/MAG)',
  `binn` VARCHAR(20) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'genome/MAG/SAG accession number [other]',
  `gsta` ENUM('complete', 'partial', 'draft') CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Genome status',
  ...
  `method` INT NULL DEFAULT NULL COMMENT 'Method used to estimate the integrity and contamination of the sample.',
  ...
  `coun` VARCHAR(30) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Country of origin',
  `regi` VARCHAR(30) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Region of origin',
  `geol` VARCHAR(80) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Geographic location',
  ...
  `sour` VARCHAR(80) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Source of sample',
  ...
  `emet` VARCHAR(500) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Energy metabolism',
  `orel` INT NULL DEFAULT NULL COMMENT 'Relationship with O2',
  `elac` VARCHAR(40) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Terminal electron acceptor',
  ...
  `salw` VARCHAR(80) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Other salts besides NaCl to be reported',
  `bios` ENUM('BSL-1', 'BSL-2', 'BSL-3', 'BSL-4') CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Biosafety level',
  `habt` VARCHAR(100) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Habitat. Description of place where the sample was collected.',
  `bior` VARCHAR(100) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Biotic relationship with other organisms.',
  `host` VARCHAR(100) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'If it is a symbiont, with which host does it interact?',
  `path` VARCHAR(200) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Known pathogenicity.',
  `extr` VARCHAR(500) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Miscellaneous, extraordinary features relevant for the description',
  `sfrac` INT NULL DEFAULT NULL COMMENT 'Sequenced fraction',
  `target` INT NULL DEFAULT NULL COMMENT 'Target nucleic acids',
  `rreads` VARCHAR(40) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Raw reads',
  `rreadacc` INT NULL DEFAULT NULL COMMENT 'Raw reads NCBI accesion code',
  `rrname` VARCHAR(100) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Name of the original file containing the raw reads',
  ...
  `treads` VARCHAR(40) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Trimmed reads',
  `trname` VARCHAR(100) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Name of the original file containing the trimmed reads',
  ...
  `assembled` VARCHAR(40) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Identificador del fitxer d’assembled',
  `assname` VARCHAR(100) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Name of the original file containing the assembly',
  ...
  `pgenes` VARCHAR(40) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Predicted genes',
  `pgenesname` VARCHAR(100) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Name of the original file containing the predicted genes',
  `nagoya` VARCHAR(500) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT 'Information related to the Nagoya Protocol',
  `sequrl` VARCHAR(400) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL COMMENT '¡Atención! No hay indicios, aclarar qué señala esta URL. ¿Puede ser lo mismo que sequrl?',
...
CREATE TABLE IF NOT EXISTS `halodb`.`hkgenes` (
  ...
  `gene` VARCHAR(25) COLLATE 'utf8mb4_bin' NULL DEFAULT NULL COMMENT 'table of generic genes. To be used as housekeeping genes.',
  PRIMARY KEY (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `halodb`.`keywords` (
  ...
  `keyword` VARCHAR(50) CHARACTER SET 'utf8mb4' NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `halodb`.`ph` (
  ...
  `vmin` FLOAT NULL DEFAULT NULL,
  `vmax` FLOAT NULL DEFAULT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `halodb`.`sample_has_keywords` (
  `sample_id` INT NOT NULL,
  `keywords_id` VARCHAR(45) CHARACTER SET 'utf8mb4' NOT NULL,
...
CREATE TABLE IF NOT EXISTS `halodb`.`user_shared_sample` (
  `user_id` INT NOT NULL,
  `sample_id` INT NOT NULL,
  `relation` ENUM('owner', 'read', 'readwrite') CHARACTER SET 'utf8mb4' NULL DEFAULT 'read' COMMENT 'Describes the acces mode to the sample. \'owner\' is the propietary, can read and write and also delete the sample. \'read\' can read the data but no change it. \'readwrite\' can read and write but not delete.',
