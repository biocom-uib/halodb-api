...
-- -----------------------------------------------------
-- Table `halodb`.`contigs`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `halodb`.`contigs` ;
CREATE TABLE IF NOT EXISTS `halodb`.`contigs` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_contigs_trimmed_reads_1_idx` (`source_id` ASC),
  CONSTRAINT `fk_contigs_trimmed_reads_1`
    FOREIGN KEY (`source_id`)
    REFERENCES `halodb`.`trimmed_reads` (`id`),
  INDEX `fk_contigs_user_1_idx` (`user_id` ASC),
  CONSTRAINT `fk_contigs_user_1`
    FOREIGN KEY (`user_id`)
